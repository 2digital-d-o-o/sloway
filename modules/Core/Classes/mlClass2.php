...
class mlClass2 extends dbClass {
    ...
    private static function genMLTable($table, $mlf, $db) {
        ...
        if (count($q)) {
            ...
            $q .= " ,PRIMARY KEY (`table_id`,`lang`)) DEFAULT CHARSET=utf8";
            
            $db->query($q);
        }
    }     

    public static function load($table, $query = "", $limit = 0, $options = null, $lang = null, $class = "\Sloway\mlClass2") {
    ...
    public static function create($table, $id = 0, $options = null, $lang = null, $class = "\Sloway\mlClass2") {
        if ($id)
    ...
    public static function post($table, $id = 0, $options = null, $lang = null, $class = '\Sloway\mlClass2') {
		$obj = self::create($table, $id, $options, $lang, $class);
		$obj->read_post();
        
        return $obj;
    }    
    public static function load_def($table, $query = "", $limit = 0, $options = null, $lang = null, $class = "\Sloway\mlClass2") {
