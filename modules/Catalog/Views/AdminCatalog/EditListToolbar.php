...
$(document).module_loaded(function() {	
    ...
    $("#catalog_undelete").click(function() {
        $.overlay_ajax(doc_base + 'AdminCatalog/Ajax_Undelete', "ajax", {
...
<?php								  
    echo Admin::SectionBegin("Filter");

	echo Admin::FieldV(et("Search"), acontrol::edit("filter_search", $filter->search, array("lines" => 5)));
