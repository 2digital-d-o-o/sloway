...
<div class="rl_template rl_template_image_text" data-name="image_text" data-collapse="1.1" data_attr_img_pos="left" style="margin-bottom: 20px">
...
<table class="rl_template rl_template_image_text" data-name="image_text" cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>
