...
<div id="<?=$id?>" class="rl_page_list">
<ul>
    <?php foreach ($items as $item): ?>
    <li>
        <div class="rl_page_list_item">
            <div class="rl_page_list_item_pad" style="padding-top: <?=$aspect_ratio?>%"></div>
            ...
            <?php if ($item->title): ?>
            <div class="rl_page_list_item_title"><?=$item->title?></div>
            <?php endif ?>
        </div>
    </li>
    <?php endforeach ?>
